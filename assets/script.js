...
var Resources = {
    pokeball: 'https://www.freepnglogos.com/uploads/football-png/drawing-football-photo-4.png',
    pokeballActive: 'https://www.freepnglogos.com/uploads/football-png/drawing-football-photo-4.png',
    pokeballClosed: 'https://www.freepnglogos.com/uploads/football-png/drawing-football-photo-4.png'
};
...
function animateCaptureState() {
    ...
    setTimeout(function() {
        ...
        if (seed < Math.floor(successRate)) {
            ...
            captureStatus.innerHTML = "You Scored!"
            makeItRainConfetti();
            ...
            var captureStatus = document.getElementById('capture-status');
            captureStatus.innerHTML = "Brand Name"
            captureStatus.classList.toggle('hidden');
